      ...
      <section className="catalog-hero">
        <div className="container catalog-hero-inner">
          ...
          <div className="catalog-hero-actions">
            ...
            <Link to="/gifting" className="btn btn-outline">
              Gift fruit guide
            </Link>
          </div>
        </div>
              ...
              <ul className="catalog-product-list">
                {products.map((product) => (
                  <li key={product.id} className="catalog-product-row">
                    <div>
                      <Link to={getProductUrl(product)} className="catalog-product-name">
                        {product.name}
                      </Link>
                      {product.description && (
                    ...
                    <Link to={getProductUrl(product)} className="btn btn-outline btn-sm">
                      View &amp; order
                    </Link>
                  </li>
                ))}
      ...
      <section className="section catalog-order-help">
        <div className="container catalog-order-help-inner">
          ...
          <aside className="catalog-order-card">
            ...
            <Link to="/gifting" className="catalog-order-secondary">
